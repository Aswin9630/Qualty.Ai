            ...
            <tbody>
              {items.map((it, idx) => (
                <tr key={idx}>
                  ...
                  <td>{it.quantity || 1}</td>
                  <td>{it.unit || "-"}</td>
                  <td className="right">{formatMajor(it.unitPriceMajor, it.currency || totals.currency)}</td>
                  <td className="right">{formatMajor(it.totalMajor, it.currency || totals.currency)}</td>
                </tr>
              ))}
            </tbody>
            <tfoot>
              <tr>
                <td colSpan="4" className="right" style={{ fontWeight: 600 }}>Subtotal</td>
                <td className="right">{formatMajor(totals.subtotal, totals.currency)}</td>
              </tr>
              <tr>
                <td colSpan="4" className="right">Tax</td>
                <td className="right">{formatMajor(totals.tax, totals.currency)}</td>
              </tr>
              <tr>
                <td colSpan="4" className="right" style={{ fontWeight: 700 }}>Total</td>
                <td className="right" style={{ fontWeight: 700 }}>{formatMajor(totals.total, totals.currency)}</td>
              </tr>
            </tfoot>
          </table>
