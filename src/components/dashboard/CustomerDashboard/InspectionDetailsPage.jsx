...
//                 const currencySymbol = getCurrencySymbol(bid.currency || "INR");
...
//                       <p>
//                         <strong>Bid Amount:</strong> {currencySymbol}{displayedBidAmount}/-
//                       </p>
//                       <p>
...
//                         <>
//                           <p><strong>Paid (30%):</strong> {enquiry.currency==="INR"?"₹":"$"}{amountPaid}</p>
//                           <p><strong>Balance (70%):</strong> {enquiry.currency==="INR"?"₹":"$"}{balanceAmount}</p>
//                         </>
//                       )}
//                     </div>
