...
export default function DetailAnalysis() {
  ...
  const currency = stats.currency || customer?.currency || "INR";
    ...
    <div className="min-h-screen bg-white text-black px-6 py-10">
      <div className="max-w-6xl mx-auto space-y-10 animate-fade-in">
        ...
        <InfoCard
          ...
          title="Payment Stats"
          data={{
            "Total Paid": `${symbol}${totalPaid}`,
            "Pending Payments": `${symbol}${pendingPayment}`,
            "Average Payment": `${symbol}${averagePayment}`,
            "Payment Success Rate": `${paymentSuccessRate}%`,
          }}
          progress={{ label: "Payment Success", value: animatedPaymentSuccess }}
          glow="green"
