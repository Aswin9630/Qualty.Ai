...
export default function CompletedTasksCard() {
  ...
  return (
    ...
    <div className="bg-white text-black rounded-xl shadow-lg border border-gray-200 p-6 transition-all duration-300 hover:shadow-xl">
      ...
      <p className="text-4xl font-semibold tracking-tight">{stats?.completedTasks || 0}</p>
      <p className="text-sm font-medium text-black mt-4 inline-block hover:underline hover:text-gray-800 transition duration-200 cursor-pointer"> View History →</p>
    </div>
      </Link>
  );
}
