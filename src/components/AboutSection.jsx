...
import phoneImage from "../assets/3phone1.png";
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="md:col-span-7 lg:col-span-8 space-y-6">
            <div className="text-left p-6 sm:p-8 shadow-[inset_0_0_0.5px_rgba(255,255,255,0.05)] backdrop-blur-md rounded-lg transition hover:shadow-[0_0_30px_rgba(255,255,255,0.06)]">
              ...
              <p className="text-gray-300 max-w-3xl mt-4 leading-relaxed">
                ...
                traders with certified inspection firms and freelancers. It
                streamlines inspection demands by offering a centralized
                platform to create requests, get competitive quotes, track
                status, and receive live updates. With stakeholder collaboration
                and transparent reporting, Quality.AI simplifies the entire
                inspection process.
              </p>
            </div>
        ...
        <div className="mt-10">
          <div className="text-center p-6 sm:p-8 shadow-[inset_0_0_0.5px_rgba(255,255,255,0.05)] backdrop-blur-md rounded-lg transition hover:shadow-[0_0_30px_rgba(255,255,255,0.06)]">
            <h3 className="text-lg sm:text-5xl font-bold mb-3">
              What You Get With Qualty.AI
            </h3>
         

          <div className="mt-16 flex flex-col sm:flex-row items-center justify-center space-y-10">
            <img
              src={phoneImage}
              alt="Qualty.AI Mobile Preview"
              className="w-[280px] sm:w-[350px] md:w-[950px] transition-transform hover:scale-[1.03]"
            />

            <p className="text-gray-300 italic font-semibold max-w-3xl mx-auto text-lg sm:text-xl leading-relaxed">
