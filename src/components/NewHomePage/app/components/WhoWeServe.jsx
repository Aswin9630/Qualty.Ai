...
//           <div className="text-sm text-black/40 mb-4 tracking-wide uppercase">Solutions</div>
...
//               <img src={currentRole.image} alt={currentRole.title} className="absolute inset-0 w-full h-full object-contain" />
